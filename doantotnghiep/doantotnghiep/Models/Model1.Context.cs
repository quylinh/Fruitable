...
namespace doantotnghiep.Models
{
    ...
    public partial class FreshFruitDBEntities : DbContext
    {
        public FreshFruitDBEntities()
            : base("name=FreshFruitDBEntities")
        {
        }
        ...
        public virtual DbSet<NhanXetSanPham> NhanXetSanPhams { get; set; }
